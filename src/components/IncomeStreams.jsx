...
const IncomeStreamsForm = () => {
  ...
  const handleCheckboxSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://konasal-complete-website-backend.onrender.com/api/forms",
        {
          method: "POST",
      ...
      console.error(err);
      toast.error("Failed to submit checkbox form.");
    } finally {
  ...
  const handleInputFormSubmit = async (e) => {
    ...
    try {
      ...
      console.error(err);
      toast.error("Failed to submit input form.");
    } finally {
      ...
      <section className="top-section">
        <div className="topDiv">
          ...
          <p className="top-subtitle">
            ...
            we’ll be happy to <br />
            provide you with resources to help you get started.
          </p>
        </div>
        ...
        <div className="formDiv">
          <form className="checkbox-form" onSubmit={handleCheckboxSubmit}>
            ...
            >
              {loadingCheckbox ? "Submitting..." : "Submit"}
            </button>
          </form>
        </div>
      </section>
      ...
      <div className="btm">
        <section className="bottom-section">
          ...
          <form className="info-form" onSubmit={handleInputFormSubmit}>
            ...
            >
              {loadingInput ? "Submitting..." : "Submit"}
            </button>
          </form>
        </section>
      </div>
